...
function showValidationModal() {
  ...
  const body = document.getElementById('ed-validationBody');
  ...
  document.getElementById('ed-validationModal').classList.remove('hidden');
}
...
function renderForm(specs, values) {
  const form = document.getElementById('ed-entityForm');
  form.innerHTML = '';
  specs.forEach(spec => {
...
function showFormError(message) {
  const el = document.getElementById('ed-formError');
  el.textContent = message;
  el.classList.remove('hidden');
}
function hideFormError() {
  document.getElementById('ed-formError').classList.add('hidden');
}

function openAddModal(kind) {
  currentKind = kind;
  currentEditId = null;
  document.getElementById('ed-formTitle').textContent = ADD_TITLES[kind];
  renderForm(FIELD_SPECS[kind], {});
  hideFormError();
  document.getElementById('ed-formModal').classList.remove('hidden');
...
function openEditModal(kind, id) {
  ...
  document.getElementById('ed-formTitle').textContent = EDIT_TITLES[kind];
...
function closeFormModal() {
  document.getElementById('ed-formModal').classList.add('hidden');
}

document.getElementById('ed-formCancel').addEventListener('click', closeFormModal);
document.getElementById('ed-formModal').addEventListener('click', e => {
  if (e.target.id === 'formModal') closeFormModal();
});

document.getElementById('ed-formSubmit').addEventListener('click', () => {
...
document.getElementById('ed-validateBtn').addEventListener('click', showValidationModal);
document.getElementById('ed-validationClose').addEventListener('click', () => {
  document.getElementById('ed-validationModal').classList.add('hidden');
});
document.getElementById('ed-validationModal').addEventListener('click', e => {
  if (e.target.id === 'validationModal') document.getElementById('ed-validationModal').classList.add('hidden');
});
...
document.querySelectorAll('.tab').forEach(tab => {
  tab.addEventListener('click', () => {
    ...
    document.getElementById('ed-panel-' + tab.dataset.tab).classList.add('active');
  });
});
...
function setEmptyState(kind, isEmpty) {
  document.getElementById('ed-table-' + kind).closest('.table-wrap').classList.toggle('empty', isEmpty);
}

function renderOwnersTable() {
  const tbody = document.querySelector('#ed-table-owners tbody');
  tbody.innerHTML = '';
...
function renderShopsTable() {
  const tbody = document.querySelector('#ed-table-shops tbody');
  tbody.innerHTML = '';
...
function renderRelationsTable() {
  const tbody = document.querySelector('#ed-table-relations tbody');
  tbody.innerHTML = '';
...
function updateStats() {
  document.getElementById('ed-statOwners').textContent = data.owners.length;
  document.getElementById('ed-statShops').textContent = data.shops.length;
  document.getElementById('ed-statRelations').textContent = data.relations.length;
}
...
// ------------------------------------------------------------------
document.getElementById('ed-fileInput').addEventListener('change', e => {
...
document.getElementById('ed-downloadBtn').addEventListener('click', () => {
...
document.getElementById('ed-exportVisualizerBtn').addEventListener('click', () => {
  const payload = buildVisualizerPayload();
...
document.getElementById('ed-sampleBtn').addEventListener('click', () => {
